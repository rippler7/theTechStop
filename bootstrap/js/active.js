(function ($) {
    ...
    var proCata = $('.jermany-pro-category');
    ...
    var jermanySearch = $('.search-nav');
    var searchClose = $('.search-close');

    jermanySearch.on('click', function () {
    ...
    var jermanyMobNav = $('.jermany-navbar-toggler');
    var navClose = $('.nav-close');

    jermanyMobNav.on('click', function () {
